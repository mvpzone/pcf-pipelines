...
network_configuration=$(
  jq -n \
    ...
    --arg infra_network_cidr "10.16.101.0/26" \
    --arg infra_reserved_ip_ranges "10.16.101.1-10.16.101.9" \
    --arg infra_dns "10.16.101.1,8.8.8.8" \
    --arg infra_gateway "10.16.101.1" \
    ...
    --arg deployment_network_cidr "10.16.16.0/22" \
    --arg deployment_reserved_ip_ranges "10.16.16.1-10.16.16.9" \
    --arg deployment_dns "10.16.16.1,8.8.8.8" \
    --arg deployment_gateway "10.16.16.1" \
    ...
    --arg services_network_cidr "10.16.20.0/22" \
    --arg services_reserved_ip_ranges "10.16.20.1-10.16.20.9" \
    --arg services_dns "10.16.20.1,8.8.8.8" \
    --arg services_gateway "10.16.20.1" \
    ...
    --arg dynamic_services_network_cidr "10.16.24.0/22" \
    --arg dynamic_services_reserved_ip_ranges "10.16.24.1-10.16.24.9" \
    --arg dynamic_services_dns "10.16.24.1,8.8.8.8" \
    --arg dynamic_services_gateway "10.16.24.1" \
